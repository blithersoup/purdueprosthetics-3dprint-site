...
const RequestView: FC<RVprops> = ( { request } ): JSX.Element => {
    ...
    return(
        <Box as='button' borderRadius='md' color='wide' maxW='large' maxH='medium' borderWidth='1px' onClick={() => { router.push(linkString)}}>
                ...
                <Text fontSize='small'>
                    ...
                    <Text fontSize='small'>
                    URL to model: <Link href={request.url} color='green' isExternal>link</Link>
                    </Text>
                    <Text fontSize='small'>
